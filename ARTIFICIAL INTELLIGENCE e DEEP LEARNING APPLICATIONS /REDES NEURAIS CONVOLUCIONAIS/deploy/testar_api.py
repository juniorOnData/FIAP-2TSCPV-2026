"""
testar_api.py — cliente de teste do serviço (cnn_junior)
--------------------------------------------------------------
Cópia adaptada de cnn/deploy/testar_api.py. Gera PNGs a partir do teste do
Fashion-MNIST, envia para a API e compara com o rótulo verdadeiro.
